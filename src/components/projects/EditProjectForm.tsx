...
import type { Project, ProjectFormData } from "@/types/index.ts";
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <input
            ...
            className="bg-fuchsia-600 w-full p-3 text-white uppercase font-bold cursor-pointer hover:bg-fuchsia-700 transition-colors"
          />
        </form>
      </div>
    </>
